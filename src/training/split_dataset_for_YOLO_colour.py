...
output_dir = Path("datasets/dataset_yolo_warp_colour")
...
if __name__ == "__main__":
    ...
    for split in ["train", "val", "test"]:
        ...
        os.makedirs(f"{output_dir}/visualisations/{split}", exist_ok=True)
    ...
    for class_dir in class_dirs:
        ...
        for split_name, split_files in splits.items():
            for img_path in split_files:
                ...
                # Save
                cv2.imwrite(f"{dest_img_dir}/{img_path.name}", img)
                ...
                if pixel_bbox is not None:
                    ...
                    cv2.imwrite(f"{dest_vis_dir}/{img_path.name}", vis_img)

    # Preprocessed images
    yaml_path = f"../{output_dir}/data.yaml"
    with open(yaml_path, "w") as f:
        f.write(f"train: /Users/lara.howe/Library/CloudStorage/OneDrive-Accenture/Documents/comp vision/major_project/src/datasets/dataset_yolo_warp_colour/images/train\n")
        f.write(f"val: /Users/lara.howe/Library/CloudStorage/OneDrive-Accenture/Documents/comp vision/major_project/src/datasets/dataset_yolo_warp_colour/images/val\n")
        f.write(f"test: /Users/lara.howe/Library/CloudStorage/OneDrive-Accenture/Documents/comp vision/major_project/src/datasets/dataset_yolo_warp_colour/images/test\n\n")
